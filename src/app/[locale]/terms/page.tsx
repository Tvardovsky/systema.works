        ...
        <div className="page-shell">
          ...
          >
            ...
            <div className="navbar-end gap-2">
              <a href={`/${locale}/#contact`} className="btn btn-primary btn-sm rounded-full" data-testid="nav-contact-from-terms">
                {t('ctaPrimary')}
              </a>
              <LanguageSwitcher />
            </div>
            ...
            <article className="card bg-base-100 shadow-sm">
              <div className="card-body gap-6 p-6 md:p-8">
                <div className="space-y-4">
                  <h1 className="text-3xl font-black text-primary">{tt('title')}</h1>
                  <p className="text-sm text-base-content/60">{tt('lastUpdated')}</p>
                  <p className="max-w-3xl text-base leading-relaxed text-base-content/80">{tt('intro')}</p>
                </div>
                ...
                <div className="space-y-8">
                  {sections.map((sectionKey) => {
                    const section = tt.raw(`sections.${sectionKey}`) as any;
                    return (
                ...
                <div className="card-actions pt-4">
                  <a href={`/${locale}/#contact`} className="btn btn-primary rounded-full px-6" data-testid="cta-contact-from-terms">
                    {t('ctaPrimary')}
                  </a>
                </div>
              </div>
