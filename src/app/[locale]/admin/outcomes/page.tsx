...
import {AdminOutcomesDashboard} from '@/components/AdminOutcomesDashboard';
...
export default async function AdminOutcomesPage({params}: Props) {
  const {locale} = await params;
  if (locale !== 'ru' && locale !== 'en') {
    redirect('/ru/admin/outcomes');
  }
  ...
  return <AdminOutcomesDashboard locale={adminLocale} />;
}
